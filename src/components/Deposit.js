...
const Deposit = () => {
  ...
  const amountHandler = async (e) => {
    if (e.target.id === 'token1') {
      ...
      // Fetch value from chain (similar in Swap.js), reference with AMM.sol functions
      ...
      // Fetch value from chain (similar in Swap.js), reference with AMM.sol functions
      // we enter token 2 amount, we calculate token 1 deposit with token 2 amount, 
      // finally we pass _token1Amount as _token1Amount and set it
