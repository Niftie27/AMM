...
const Swap = () => {
  ...
  const [price, setPrice] = useState(0) // we use useState hook for price
  ...
  const swapHandler = async (e) => {
    ...
    await getPrice() // updates exchange rate
  ...
  const getPrice = async () => {
    ...
    // dont need to put it into redux, cuz its specific to swap component (we use useState hook for price)
  }
